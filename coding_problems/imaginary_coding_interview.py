...
Given a list , in a true condition will always be in the format [very easy, very easy, easy, easy,
...
def interview(times, total_time):
    ...
    if times[0] > 5 or times[1] > 5:
        return "disqualified"
    if times[2] > 10 or times[3] > 10:
        return "disqualified"
    if times[4] > 15 or times[5] > 15:
        return "disqualified"
    if times[6] > 20 or times[7] > 20:
        return "disqualified"
    return "qualified"
