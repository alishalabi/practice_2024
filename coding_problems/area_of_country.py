...
area_of_country("Iran", 1648195) ➞ "Iran is 1.11% of the total world's land

Problem from: https://edabit.com/challenge/Cjtm4CpLzHDerQMfX
"""

def area_of_country(country_name, area):
    total_area = 148940000
    percentage = round(area/total_area * 100, 2)
    return f"{country_name} is {percentage}% of the total world's landmass"
