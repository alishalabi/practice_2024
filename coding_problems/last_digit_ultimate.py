...
if the last digit of a * b = the last digit of c. Check the examples below for an explanation.
...
def last_dig(num1, num2, num3):
    product_last_digit = (num1 * num2) % 10
    num3_last_digit = num3 % 10
    if product_last_digit != num3_last_digit:
        return False
    return True
